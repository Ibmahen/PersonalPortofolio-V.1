...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Grid Content */}
        <div className="p-4 py-8 md:p-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center items-center min-h-[400px]">
            ...
            {/* Sticker: Code Icon */}
            <div className="hidden md:block absolute top-0 left-4 md:left-10 bg-[#40E0D0] p-3 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] -rotate-12 z-20">
              <Code size={32} strokeWidth={3} />
            </div>

            {/* Sticker: Save Icon */}
            <div className="hidden md:block absolute bottom-10 left-0 md:left-4 bg-[#ECEE81] p-3 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rotate-12 z-20">
              <Save size={28} strokeWidth={3} />
            </div>

            {/* Sticker: Terminal Icon */}
            <div className="hidden md:block absolute bottom-20 right-4 md:right-8 bg-[#FFD700] p-3 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] -rotate-6 z-20">
              <Terminal size={28} strokeWidth={3} />
            </div>

            {/* Badge: Role */}
            <div className="hidden md:block absolute -bottom-4 right-10 bg-[#90EE90] px-6 py-2 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rotate-2 z-30">
